...
// Create a new Blob file with mime-type "text/plain"
                ...
                String fullPath = baseDir + "/" + fileNamePrefix + fileNameSuffix;
                //AppEngineFile file = new AppEngineFile(fullPath);
                AppEngineFile file = fileService.createNewBlobFile("text/xml", fullPath);
...
//                    blobStoreService.fetchData(oldBlobKey, 0, 1);
                    try {
...
//                String segment = new String(blobStoreService.fetchData(blobKey, 0, 5000));
...
*/	}
	...
	public void writeSiteMap(PrintWriter  out) throws IOException {
		out.write("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n");
		out.write("<urlset xmlns=\"http://www.sitemaps.org/schemas/sitemap/0.9\" ");
